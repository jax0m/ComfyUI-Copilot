...
export const ConfigureParameterScreen: React.FC<
  ConfigureParameterScreenProps
> = ({
  selectedNodes,
  paramTestValues,
  selectedParams,
  ...
  const generateNumericTestValues = (
    min: number,
    max: number,
    step: number,
    precision: number = 0,
    ...
    selectedNodes.forEach((node) => {
      ...
      nodeWidgets.forEach((widget: any) => {
        ...
        if (!hasValues && widget.type === "number") {
          ...
          const defaultValues = generateNumericTestValues(
            min,
            max,
            step,
            precision,
        ...
        if (
          ...
          widget.type.toLowerCase().includes("text")
        ) {
          const inputKey = `${nodeId}_${paramName}`;
          ...
          if (
            ...
            JSON.stringify(paramTestValues[nodeId]?.[paramName] || [""])
          ) {
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
      <div className="mb-4 border-b pb-2 flex justify-between items-center">
        <div>
          ...
          <p className="text-xs text-gray-500">
            Configure the test values for each parameter
          </p>
        </div>
        <button
      ...
      {selectedNodes.length > 0 ? (
                      ...
                      <div key={widgetIndex} className="border-b pb-3">
                        <div className="flex justify-between items-center mb-2">
                          ...
                          <button
                            ...
                            onClick={() =>
                              openAiWritingModal(nodeId, paramName)
                            }
                          >
                            <svg
                      ...
                      <div key={widgetIndex} className="border-b pb-3">
                        ...
                        <div className="flex space-x-2 items-center">
                            ...
                            onChange={(e) => {
                              ...
                              if (value === "" || !isNaN(parseFloat(value))) {
                                ...
                                const newMax = parseFloat(
                                  currentInputs.max || max.toString(),
                                );
                                const newStep = parseFloat(
                                  currentInputs.step || step.toString(),
                                );
                                const newValues = generateNumericTestValues(
                                  newMin,
                                  newMax,
                                  newStep,
                                  precision,
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              // 只有当输入为空或有效时才更新参数值
                              if (value === "" || !isNaN(parseFloat(value))) {
                                const newMin = parseFloat(
                                  currentInputs.min || min.toString(),
                                );
                                const newMax =
                                  value === "" ? newMin : parseFloat(value);
                                const newStep = parseFloat(
                                  currentInputs.step || step.toString(),
                                );
                                const newValues = generateNumericTestValues(
                        ...
                        <div className="mt-1">
                          ...
                          <div className="mt-1 flex flex-wrap gap-1">
                            {(() => {
                              const values =
                                paramTestValues[nodeId]?.[paramName] ||
                                defaultValues;
                    ...
                    return (
                      <div key={widgetIndex} className="border-b pb-3">
                            ...
                            {openDropdowns[dropdownKey] && (
                              <div
                                ...
                                style={{
                                  position: "fixed",
                                  top:
                                    typeof openDropdowns[dropdownKey] ===
                                    "object"
                                      ? `${(openDropdowns[dropdownKey] as { y: number }).y}px`
                                      : "0px",
                                  left:
                                    typeof openDropdowns[dropdownKey] ===
                                    "object"
                                      ? `${(openDropdowns[dropdownKey] as { x: number }).x}px`
                                      : "0px",
                                  maxHeight: "300px",
                                  overflowY: "auto",
                                }}
                              >
                                ...
                                <div
                                  ...
                                  onClick={(e) => {
                                    ...
                                    const valuesToStore =
                                      filteredValues.map(getValueToStore);
                                    handleSelectAll(
                                      nodeId,
                                      paramName,
                                      valuesToStore,
                                      ...
                                      <div
                                        ...
                                        onClick={(e) => {
                                          ...
                                          handleTestValueSelect(
                                            nodeId,
                                            paramName,
                                            getValueToStore(value),
                                            e,
                                          );
                                        }}
                                      >
                                        <div
                                          className={`w-4 h-4 mr-2 border rounded-sm flex items-center justify-center ${(paramTestValues[nodeId]?.[paramName] || []).includes(getValueToStore(value)) ? "bg-blue-500 border-blue-500" : "border-gray-300"}`}
                                        >
                                          {(
                                            paramTestValues[nodeId]?.[
                                              paramName
                        ...
                        <div className="mt-2">
                          ...
                          <div className="mt-1 flex flex-wrap gap-1">
                            {(paramTestValues[nodeId]?.[paramName] || []).map(
        ...
        <div className="border rounded-md mb-4 p-4 text-center text-gray-500">
          No nodes selected. Please select a node in the workflow to configure
          parameters.
        </div>
      )}
