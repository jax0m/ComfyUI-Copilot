      ...
      <div className="text-sm text-gray-700">
        ...
        <div className="flex gap-2 mt-2">
          <button
            ...
            onClick={() =>
              onSendWithContent(
                `Reply in ${navigator.language} language: How does the ${nodeInfo[0].type} node work? I need its official usage guide.`,
              )
            }
            disabled={loading}
          >
          ...
          <button
            ...
            onClick={() =>
              onSendWithContent(
                `Reply in ${navigator.language} language: Show me the technical specifications for the ${nodeInfo[0].type} node's inputs and outputs.`,
              )
            }
            disabled={loading}
          >
          ...
          <button
            ...
            onClick={() =>
              onSendWithIntent(
                ...
                getDownstreamSubgraphExt(nodeInfo),
              )
            }
            disabled={loading}
          >
